...
//  Enables the previous variables to be read only
   ...
   */
  public static String getAuthDiscordID() {
    return DISCORD_AUTH_ID;
  }
   ...
   */
  public static String getAuthGoogleID() {
   ...
   */
  public static String getAuthSoundCloudID() {
    return SOUNDCLOUD_AUTH_ID;
  }
   ...
   */
  public static String getAuthYoutubeID() {
    return YOUTUBE_AUTH_ID;
  }
   ...
   */
  public static String getAuthSpotifyID() {
    return SPOTIFY_AUTH_ID;
  }
}
