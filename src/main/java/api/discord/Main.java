...
import api.discord.helper.TriggerFileHandler;
...
//      Generates the HashMap for triggers or a new file depending on if the file has been found or not.
      ...
      if (!newFileCreated) {
        ...
        textualTrigger.setTriggers(TriggerFileHandler.generateMap("src/files/triggers.txt"));
      } else {
  ...
  public static void shutdown() {
    logger.debug("Saving triggers to file...");
    TriggerFileHandler.saveTriggersToFile(TextualTriggers.getTriggers(), "src/files/triggers.txt");
